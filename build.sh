...
clang++ main.o operators/operatorcreator.o operators/add.o operators/minus.o operators/multiply.o operators/divide.o validator.o translator.o -o calculator
./calculator
